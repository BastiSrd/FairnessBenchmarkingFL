                    ...
                    try:
                        ...
                        if not final_row.empty:
                            all_observations.append({
                                ...
                                "accuracy": final_row["accuracy"].values[0],
                                "balanced_accuracy": final_row["balanced_accuracy"].values[0],
                                "statistical_parity": final_row["statistical_parity"].values[0],
                                "equalized_odds": final_row["equalized_odds"].values[0]
                            })
